            ...
            <div className="flex justify-center h-screen  items-center bg-teal-100">
                <div className="flex overflow-hidden shadow-2xl shadow-teal-100 w-[750px] h-[500px] rounded-xl">
                    ...
                    <div className="flex-1 p-6 bg-white">
                        <h1 className="font-semibold text-center text-4xl mb-4">Register</h1>
                        ...
                        <form action="" className=" flex flex-col gap-3 w-full">
                            ...
                            <input className="border border-teal-600 outline-none h-9 rounded p-1" type="text" name="name" placeholder="Name" />
                            ...
                            <input className="border border-teal-600 outline-none h-9 rounded p-1" type="tel" name="phone" placeholder="Phone Number" />
                            ...
                            <p className="text-sm">Already Have an account?<a className="text-teal-700 mx-1 underline" href="/"> Login Now!</a></p>
